...
export default function AllPosts() {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div id="posts" className="w-8/9 md:w-5/6 lg:w-2/3">
        {postData.posts.map((post, index) => {
          ...
          return (
            <Link to={`../${post._id}`} key={index}>
              <div className="p-4 mb-10 min-h-[200px] text-justify shadowOp flex flex-col justify-between transition-all duration-200 hover:scale-[1.04] hover:cursor-pointer">
